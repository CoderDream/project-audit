...
public class DateUtil {
	...
	public static boolean beforeToday(String beginDateString) {
		...
		try {
			...
			logger.debug("" + "Unparseable using" + df);
		}
		// 取时间
	...
	public static List<Double> getMonthBetweenParticipate(String beginDate, String endDate) {
		...
		try {
			...
			for (String string : monthStrList) {
				...
				// logger.debug(""+"dayRange \t" + dayRange);
			}
		} catch (ParseException e) {
			e.printStackTrace();
		}
	...
	public static int getDateRange(Calendar beginCal, Calendar endCal) {
		...
		// 得到两个日期相差的天数
		int days = ((int) (endCal.getTime().getTime() / 1000) - (int) (beginCal.getTime().getTime() / 1000)) / 3600 / 24;
	...
	public static void main(String[] args) {
		...
		logger.debug("" + DateUtil.getNextDate("2017-05-15", 5));
		...
		// logger.debug(""+DateUtil.beforeTotal(beginDateString1));
		// logger.debug(""+DateUtil.beforeTotal(beginDateString2));
		// logger.debug(""+DateUtil.beforeTotal(beginDateString3));
		// logger.debug(""+DateUtil.beforeTotal(beginDateString4));
		// logger.debug(""+DateUtil.beforeTotal(beginDateString5));

		logger.debug("" + DateUtil.compareTwoDate("2017-01-01", "2017-01-02"));
		logger.debug("" + DateUtil.compareTwoDate("2017-01-02", "2017-01-02"));
		logger.debug("" + DateUtil.compareTwoDate("2017-01-03", "2017-01-02"));
		...
		logger.debug("" + DateUtil.getMonthBetween(beginDateString1, endDateString1));
		logger.debug("" + DateUtil.getMonthBetween(beginDateString2, endDateString2));
		logger.debug("" + DateUtil.getMonthBetween(beginDateString3, endDateString3));
	}
}
