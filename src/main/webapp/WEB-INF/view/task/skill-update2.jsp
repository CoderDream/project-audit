...
<body>
	<div data-role="page" id="profile">
		<div role="main" class="ui-context">
			<form id="skill-update-form" method="post" action="">
				...
				<div class="ui-field-contain">
					<label for="fullname">熟练程度</label> <input
						...
						placeholder="${taskItemSkillView.proficiencyName}">
				...
				<div class="ui-field-contain pdrc-btnrow">
					<input type="submit" value="提交" id="skill-update-btn"> <input
						type="button" value="返回" id="skill-update-rtn-btn">
				</div>
			</form>
		</div>
	</div>
